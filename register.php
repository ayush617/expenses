...
if (isset($_POST['submit'])) 
{
    ...
    $date=$_POST['date'];
     ...
     $query="INSERT INTO user(name,email,pemail,username,password,dob,ph) VALUES('$name','$email','$pemail','$username','$password','$date','$number')";
...
<td>
&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="number" required min="0000000000">
</td>
</tr>
<tr>
<td></td>
